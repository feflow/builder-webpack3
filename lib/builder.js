...
class Builder extends BuilderCore {
    ...
    static createDevConfig(options) {
        ...
        // 设置图片解析规则
        devRules.push(this.setImgRule(true));
        // 设置CSS解析规则
        ...
        devConfig.resolveLoader = this.setResolveLoaderPath('builder-webpack3', options.runtime);
    ...
    static createProdConfig(options) {
        ...
        prodPlugins.push(this.setDoneErrorPlugin());
        ...
        // 设置 loader 的npm包查找的相对路径，此处设置在全局的 .feflow 目录下
        prodConfig.resolveLoader = this.setResolveLoaderPath('builder-webpack3', options.runtime);
