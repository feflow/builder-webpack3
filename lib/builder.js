...
class Builder {
    ...
    static createDevConfig(options) {
        ...
        // 设置TS解析规则
        devRules.push(Builder._setTsRule());
        // 设置字体解析规则
        ...
        // 抽离公共js
        // devPlugins.push(Builder._setCommonsChunkPlugin());
        // 多页面打包
    ...
    static createProdConfig(options) {
        ...
        const cdnUrl = moduleName ? `//${cdn}/${product}/${moduleName}/${bizName}` : `//${cdn}/${product}`;
        const serverUrl = moduleName ? `//${domain}/${moduleName}/${bizName}` : `//${domain}`;
        ...
        // 设置TS解析规则
        prodRules.push(Builder._setTsRule());
        // 设置字体解析规则
        ...
        // 抽离公共js
        //prodPlugins.push(Builder._setCommonsChunkPlugin());
